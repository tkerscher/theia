#ifndef _INCLUDE_SURFACE_MODEL_TROWBRIDGE_REITZ_SHADOWED_BACKWARD
#define _INCLUDE_SURFACE_MODEL_TROWBRIDGE_REITZ_SHADOWED_BACKWARD
...
#include "surface/dielectric_rough/trowbridge_reitz_shadowed/template.glsl"
